...
app.layout = html.Div([
    dcc.Tabs(id="tabs", children=[
        ...
        html.Div([
            html.Div([
                html.Div([
                    html.Img(src="https://user-images.githubusercontent.com/34200538/62165938-8c28fb00-b2ed-11e9-817b-7113ebc95cbc.png", height = 650, width = 32),
                ], className="col-"),
                html.Div([
    ...
    html.Div([
        ...
        html.Div([
            ...
            dcc.Checklist(id = 'positions',
                        ...
                        value=['Goalkeeper', 'Defender', "Midfielder",  'Forward'],
        ...
        html.Div([
            html.Img(src="https://user-images.githubusercontent.com/34200538/62166082-dca05880-b2ed-11e9-860e-5f1a80e00957.png", height = 620, width = 320, className="six columns"),
            ...
            html.Div([
                dash_table.DataTable(
                    ...
                    columns=[{'id':col, 'name':col} for col in players_df.columns],
