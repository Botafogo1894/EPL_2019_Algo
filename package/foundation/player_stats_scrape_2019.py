...
from EPL_table_scrape_2019 import test
    ...
    for item in test:
        for team in teams:
            if item['team']['id'] == 65 and team['code'] == 43:
                ...
                team['name'] = item['team']['name']
            elif item['team']['id'] == 58 and team['code'] == 7:
                team['name'] = item['team']['name']
            elif item['team']['id'] == 68 and team['code'] == 45:
                team['name'] = item['team']['name']
            elif item['team']['id'] == 356 and team['code'] == 49:
                team['name'] = item['team']['name']
    return teams
...
player_positions_teams = attach_team_and_position(all_players, all_teams_new, positions)
